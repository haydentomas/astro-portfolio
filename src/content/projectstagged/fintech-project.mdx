...
homeText1: 'The client wanted to move to Wordpress, but retain much of the UX they were already used to. For this reason we decided to build in with Oxygen as it allowed us to build our specific elements that the Zumo team could drop into place on any page.'
