---
title: 'Fintech Website Migration'
client: 'Fintech Company (Scotland)'
challenge: 'Migrate a complex Webflow site to WordPress while maintaining performance and security'
subTitle: 'Webflow to Wordpress Migration'
description: 'We were approached by a fintech company based in Scotland to migrate an existing site from Webflow to Wordpress and were happy to take on the challenge.'
...
whatwedid:
 - Custom WordPress development with Oxygen Builder
 - Implemented secure authentication and data encryption
 - Optimized for speed with CDN setup and lazy loading 
 - Delivered training and video tutorials for client onboarding
...
The site was built with a mobile-first approach and is fully responsive. The site is also optimised for speed and performance. We hosted it on Cloudways and set up a CDN to ensure fast load times. This was important as the client wanted to provide a fast and efficient service to their customers.
